...
# spurious empty lines at the beginning or end of any block.
...
class Python(Block):
    ...
    #     To extend this to second-level definitions and beyond, we're going to have to introduce some
...
class Parser:
    ...
    # parse any comments that appear on a line by itself, such as these, as
    # Markdown.
    ...
    def parse(self):
        ...
        for line in self.input_src:
            if self.state == State.Docstring:
                ...
                # to change our state
                if '"""' in line:
                    # It should matter if the closed symbol is down the text or at the end of the last line
